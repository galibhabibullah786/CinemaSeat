...
export default function CheckoutPage() {
  ...
  const releaseMutation = useMutation({
    mutationFn: () => cinemaApi.cancelHold(bookingRef),
    onSuccess: () => {
      toast.success("Seat hold released");
      navigate("/lookup");
    },
    onError: (error: unknown) => {
      toast.error("We couldn't release this hold", { description: (error as ApiError).message });
    },
  });
  useEffect(() => {
